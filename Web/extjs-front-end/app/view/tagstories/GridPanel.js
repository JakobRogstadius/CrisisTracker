Ext.define('CrisisTracker.view.latestnews.GridPanel', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.latestNewsGridPanel',
	store: 'LatestNewsProxy',
    dockedItems: [{
        xtype: 'pagingtoolbar',
        store: 'LatestNewsProxy',   // same store GridPanel is using
        dock: 'bottom',
        displayInfo: true
    }],	
    columns: [
