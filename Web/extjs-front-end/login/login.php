...
function printLogin() {
  ...
  try {
    if (isLoggedIn())
    {
      echo '<a href="userprofile.php?userid=' . $_COOKIE['twitter_id'] . '">' . $_COOKIE['twitter_name'] . '</a>&nbsp;<a href="login/logout.php">Log out</a>';
    }
    else
    {
    ...
    echo $e->getMessage() . ' [<a href="login/logout.php">Log out</a>]';
  }
}
