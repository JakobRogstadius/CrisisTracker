...
{
    class FilterStreamConsumerAidr : TwitterStreamConsumerAidr
    {
        FilterUpdateTracker _filterTracker;

        public FilterStreamConsumerAidr()
            : base(CrisisTracker.Common.Settings.FilterStreamConsumerAidr_ChannelName, CrisisTracker.Common.Settings.FilterStreamConsumerAidr_CrisisCode)
        {
        ...
        protected override InMemoryCredentials GetCredentials()
        {
            return new InMemoryCredentials()
            {
                ...
                OAuthToken = Common.Settings.FilterStreamConsumer_AccessToken, //LinqToTwitter uses strange parameter naming here
